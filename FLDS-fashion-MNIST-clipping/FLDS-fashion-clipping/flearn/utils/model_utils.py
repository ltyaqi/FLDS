...
def read_data(train_data_dir, test_data_dir):
    ...
    # print("查看客户端的ID地址：{}\n {}".format(len(clients),clients[999]))
    # print("查看train_data:{}\n {}\n{}\n".format(len(train_data),np.array(train_data[clients[0]]["x"]).shape,
    #                                           np.array(train_data[clients[0]]["y"]).shape))
    # print("查看test_data的形式：{}\n{}\n{}".format(len(test_data),np.array(test_data[clients[0]]["x"]).shape,
    #       np.array(test_data[clients[0]]["y"]).shape))
...
class Metrics(object):
    ...
    def write(self):
        ...
        metrics['MAD_n'] = self.params['MAD_n']
        ...
        metrics_dir = os.path.join(self.path, self.params['dataset'],
                                   'metrics_{}_{}_{}_{}_{}_{}_{}_{}_{}_{}.json'.format(self.params['dataset'],  # noqa: E501
                                                                              self.params['MAD_n'],
